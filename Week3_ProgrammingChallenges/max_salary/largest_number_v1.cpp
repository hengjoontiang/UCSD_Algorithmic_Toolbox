 ...
 *  for int u= 0 ; u < len2check; u++
 * 		if (u >shorter_len) shorter_char = shorter_str[shorter_len];
 * 		else shorter_char = shorter_str[u];
 * 		
...
string largest_number(vector<string> a) {
  ...
  std::sort(a.begin(),a.end(),compareByStringValue);
